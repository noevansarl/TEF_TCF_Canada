...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q1-sherbrooke.mp3',
  2,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q2-train.mp3',
  2,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q3-immigration.mp3',
  2,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q4-satellite.mp3',
  1,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q17-meteo.mp3',
  2,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q18-syndicats.mp3',
  2,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q19-musees.mp3',
  2,
  NULL,
...
(
  ...
  'https://ifbbwbyxdjxsbuilzzig.supabase.co/storage/v1/object/public/questions-audio/co-q20-puces.mp3',
  1,
  NULL,
